...
def to36(q, alphabet='0123456789abcdefghijklmnopqrstuvwxyz'):
    l = len(alphabet)
    converted = []
    while (q != 0):
        (q, r) = divmod(q, l)
...
def from36(s, alphabet='0123456789abcdefghijklmnopqrstuvwxyz'):
    l = len(alphabet)
    return int(s, 36)
...
timechunks = (((((60 * 60) * 24) * 365), TimeText('year', 'years')),
              ...
              (((60 * 60) * 24), TimeText('day', 'days')), ((60 * 60), TimeText('hour', 'hours')), (60, TimeText('minute', 'minutes')), (1, TimeText('second', 'seconds')))
