...
import usefulthings.github_stuff.path_stuff
...
#import usefulthings.shell
#publish_cmdline(writer=manpage.Writer(), description=description)
docutils_cmd ='http://docutils.sf.net/docs/user/config.html'
#rst2man.py,fetch_file,curl-config,curl,csvgrep,coverage-3.6,.anaconda-navigator-post-link.sh,.anaconda-navigator-pre-unlink.sh
#rst2html.py,pydoc3.6,pkginfo,pkgdata,pip-sync,pip-compile,makeconv,jupyter-qtconsole,jupyter-notebook
